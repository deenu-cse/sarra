...
import { Waves, Info, CheckCircle2 } from 'lucide-react';

import RiverDetailsSection from '../common/RiverDetailsSection';

export default function PartnerDetailPanelGPPNIHE() {
    const tableColumns = [
    ...
    const tableData = [
        { name: 'Jata Ganga', image: '/assets/one_river/Jata Ganga.png', district: 'Almora', mou: '27th March 2026', deadline: '28th April 2026', received: 'Yes (Received)', timeline: '26th July 2026' },
        { name: 'Garud Ganga', image: '/assets/one_river/gaur ganga.jpg.jpeg', district: 'Bageshwar', mou: '27th March 2026', deadline: '28th April 2026', received: 'Yes (Received)', timeline: '26th July 2026' },
        { name: 'Purvi Ramganga', image: '/assets/one_river/Poorvi Ramganga.webp', district: 'Pithoragarh', mou: '27th March 2026', deadline: '28th April 2026', received: 'Yes (Received)', timeline: '26th July 2026' },
    ];
    ...
    return (
        <main className="min-h-screen bg-slate-50 font-sans pb-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                    <div className="p-4 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-start">
                        ...
                        <div className="space-y-4 flex-1 text-center md:text-left">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-blue-900 leading-tight">G.B. Pant National Institute of Himalayan Environment, Almora</h1>
            ...
            <RiverDetailsSection columns={tableColumns} data={tableData} highlightedRivers={['Jata Ganga', 'Garud Ganga', 'Ramganga']} />
        </main>
    );
}
