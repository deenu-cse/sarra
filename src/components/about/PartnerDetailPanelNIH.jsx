...
const IMG = {
    hero: '/assets/research-partners/nihimg.jpg'
};
...
export default function PartnerDetailPanelNIH() {
    ...
    const tableData = [
        { name: 'Nayar (Eastern & Western)', image: '/assets/one_river/Nayar.png', district: 'Pauri', mou: '27th March 2026', deadline: '11th May 2026', received: 'Yes (Received)', timeline: '26th July 2026' },
        { name: 'Song', image: '/assets/one_river/Song.jpg.jpeg', district: 'Tehri', mou: '27th March 2026', deadline: '11th May 2026', received: 'Yes (Received)', timeline: '26th July 2026' },
        { name: 'Song', image: '/assets/one_river/Song.jpg.jpeg', district: 'Dehradun', mou: '27th March 2026', deadline: '11th May 2026', received: 'Yes (Received)', timeline: '26th July 2026' },
    ];
    ...
    return (
        <main className="min-h-screen bg-slate-50 font-sans pb-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                    <div className="p-4 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-start">
                        ...
                        <div className="space-y-4 flex-1 text-center md:text-left">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-blue-900 leading-tight">National Institute of Hydrology</h1>
            ...
            <RiverDetailsSection columns={tableColumns} data={tableData} highlightedRivers={['Nayar', 'Song']} />
        </main>
    );
}
