...
export default function PartnerDetailPanelWII() {
    const tableColumns = [
    ...
    const tableData = [
        { name: 'Pathari River', image: '/assets/one_river/pathari haridwar.jpeg', district: 'Haridwar', mouStatus: 'Draft MOU submitted', reportStatus: 'Pending' },
    ];
    ...
    return (
        <main className="min-h-screen bg-slate-50 font-sans pb-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                    <div className="p-4 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-start">
                        ...
                        <div className="space-y-4 flex-1 text-center md:text-left">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-blue-900 leading-tight">Wildlife Institute of India, Dehradun</h1>
                            ...
                            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-slate-700 leading-relaxed text-sm md:text-base">
                                <p>The Wildlife Institute of India (WII), Dehradun is a premier autonomous institution under the Ministry of Environment, Forest and Climate Change. With deep expertise in ecological research and watershed biodiversity, WII has been engaged under the SARRA program for scientific planning and sub-catchment prioritisation of the Pathri River in Haridwar district. The MoU process is currently in progress.</p>
                            </div>
                            <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-800 px-4 py-2 rounded-full border border-blue-200 font-semibold text-xs md:text-sm">
                                <Info size={16} /> Status: 🔄 In Process
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <RiverDetailsSection columns={tableColumns} data={tableData} highlightedRivers={['Pathari']} />
        </main>
    );
}
