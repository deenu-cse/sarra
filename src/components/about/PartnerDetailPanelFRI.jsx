...
export default function PartnerDetailPanelFRI() {
    const tableColumns = [
    ...
    const tableData = [
        { name: 'Chandrabhaga', image: '/assets/one_river/chandrabhaga chmoli.jpeg', district: 'Chamoli', mou: '19th May 2026', deadline: '18th June 2026', received: 'Pending', timeline: '18th October 2026' },
        { name: 'Punar', image: '/assets/one_river/punaar rudraprayag.jpeg', district: 'Rudraprayag', mou: '19th May 2026', deadline: '18th June 2026', received: 'Pending', timeline: '18th October 2026' },
    ];
    ...
    return (
        <main className="min-h-screen bg-slate-50 font-sans pb-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                    <div className="p-4 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-start">
                        ...
                        <div className="space-y-4 flex-1 text-center md:text-left">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-blue-900 leading-tight">Forest Research Institute, Dehradun</h1>
            ...
            <RiverDetailsSection columns={tableColumns} data={tableData} highlightedRivers={['Chandrabhaga', 'Punaar']} />
        </main>
    );
}
