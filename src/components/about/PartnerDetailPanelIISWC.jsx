...
export default function PartnerDetailPanelIISWC() {
    const tableColumns = [
    ...
    const tableData = [
        { name: 'Kamal Ganga', image: '/assets/one_river/kamal ganga.jpg.jpeg', district: 'Uttarkashi', mouStatus: 'Budget sanctioned, MoU with institute is in process', reportStatus: 'In Process' },
    ];
    ...
    return (
        <main className="min-h-screen bg-slate-50 font-sans pb-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                    <div className="p-4 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-start">
                        ...
                        <div className="space-y-4 flex-1 text-center md:text-left">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-blue-900 leading-tight">Indian Institute of Soil and Water Conservation, Dehradun</h1>
            ...
            <RiverDetailsSection columns={tableColumns} data={tableData} highlightedRivers={['Kamal Nadi', 'Kamal Ganga']} />
        </main>
    );
}
